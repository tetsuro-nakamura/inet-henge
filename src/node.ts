...
export class Node {
    ...
    undisplayCallback(element: SVGGElement): void {
        d3.select(element).style('display', this.undisplay());
    }

    displayCallback(element: SVGGElement): void {
        d3.select(element).style('display', this.displayOn());
    }
